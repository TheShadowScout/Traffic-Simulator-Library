...
// TO DO
// zapobiega� wielokrotnemu wywo�aniu raz naci�ni�tego przycisku � na p�niej
// uniwersalno�� wymiar�w okienka
...
int main()
{
    ...
    font.loadFromFile("calibri.ttf"); // TODO: zabezpieczy� na wypadek b��du
